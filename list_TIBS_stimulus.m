...
% filepath='E:\Zhaochenguang\Data\TIBS\Oridata\';
% file=[filepath,fileame,'.cdt'];
% savename=[fileame,'.set'];
% savepath=['E:\Zhaochenguang\Data\TIBS\CDT2set\',fileame];
...
binname='WM_bin_correct_stimulus.txt';
trialleft_name=[filename,'_trialleft_stimulus.txt'];
%savename='subname_ICA.set';
erpname_2=[filename,'_diff_stimulus'];
...
EEG = pop_epochbin( EEG , [-200  1200.0],  [-200 0]);
