%% grand average A1 ERD
        clear all
        cd 'G:\Zhaochenguang\Data\TIBS\Filedtrip_TF\ERD\Exp4\'
        Path='G:\Zhaochenguang\Data\TIBS\Filedtrip_TF\ERD\Exp4\*A_pre_clean_V_TF_ERD1.mat';
        File=dir(Path);
        nsubj = length(File);
        for i=1:nsubj   
        load(File(i).name);
 ...
 %% grand average A2 ERD
        Path='G:\Zhaochenguang\Data\TIBS\Filedtrip_TF\ERD\Exp4\*A_pre_clean_V_TF_ERD2.mat';
        File=dir(Path);
        nsubj = length(File);
        for i=1:nsubj   
        load(File(i).name);
 ...
 %% grand average S1 ERD
        Path='G:\Zhaochenguang\Data\TIBS\Filedtrip_TF\ERD\Exp4\*S_pre_clean_V_TF_ERD1.mat';
        File=dir(Path);
        nsubj = length(File);
        for i=1:nsubj   
        load(File(i).name);
 ...
 %% grand average S2 ERD
        Path='G:\Zhaochenguang\Data\TIBS\Filedtrip_TF\ERD\Exp4\*S_pre_clean_V_TF_ERD2.mat';
        File=dir(Path);
        nsubj = length(File);
        for i=1:nsubj   
        load(File(i).name);
