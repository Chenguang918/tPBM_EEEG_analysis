%% grand average A1 ERD
        clear all
        cd 'G:\Zhaochenguang\Data\TIBS\Filedtrip_TF\ERD\Exp3\'
        Path='G:\Zhaochenguang\Data\TIBS\Filedtrip_TF\ERD\Exp3\*A_pre_ICA_clean_V_TF_ERD1.mat';
        File=dir(Path);
        nsubj = length(File);
        for i=1:nsubj   
        load(File(i).name);
 ...
 %% grand average A2 ERD
        Path='G:\Zhaochenguang\Data\TIBS\Filedtrip_TF\ERD\Exp3\*A_pre_ICA_clean_V_TF_ERD2.mat';
        File=dir(Path);
        nsubj = length(File);
        for i=1:nsubj   
        load(File(i).name);
 ...
 %% grand average S1 ERD
        Path='G:\Zhaochenguang\Data\TIBS\Filedtrip_TF\ERD\Exp3\*S_pre_ICA_clean_V_TF_ERD1.mat';
        File=dir(Path);
        nsubj = length(File);
        for i=1:nsubj   
        load(File(i).name);
 ...
 %% grand average S2 ERD
        Path='G:\Zhaochenguang\Data\TIBS\Filedtrip_TF\ERD\Exp3\*S_pre_ICA_clean_V_TF_ERD2.mat';
        File=dir(Path);
        nsubj = length(File);
        for i=1:nsubj   
        load(File(i).name);
...
stat=ttest(ERD_2S-ERD_1S,ERD_2A-ERD_1A);
figure
y1=ERD_2S-ERD_1S;
y2=ERD_2A-ERD_1A;
plot(Grandavg1A.time,mean(y1,1),'b')
