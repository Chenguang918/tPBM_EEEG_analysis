%% grand average A1 ERD
        clear all
        cd 'G:\Zhaochenguang\Data\TIBS2.0\Filedtrip_TF\ERD\'
        Path='G:\Zhaochenguang\Data\TIBS2.0\Filedtrip_TF\ERD\*A_filt_int_removeICA_TF_ERD1.mat';
        File=dir(Path);
        nsubj = length(File);
        for i=1:nsubj   
        load(File(i).name);
 ...
 %% grand average A2 ERD
        Path='G:\Zhaochenguang\Data\TIBS2.0\Filedtrip_TF\ERD\*A_filt_int_removeICA_TF_ERD2.mat';
        File=dir(Path);
        nsubj = length(File);
        for i=1:nsubj   
        load(File(i).name);
 ...
 %% grand average S1 ERD
        Path='G:\Zhaochenguang\Data\TIBS2.0\Filedtrip_TF\ERD\*S_filt_int_removeICA_TF_ERD1.mat';
        File=dir(Path);
        nsubj = length(File);
        for i=1:nsubj   
        load(File(i).name);
 ...
 %% grand average S2 ERD
        Path='G:\Zhaochenguang\Data\TIBS2.0\Filedtrip_TF\ERD\*S_filt_int_removeICA_TF_ERD2.mat';
        File=dir(Path);
        nsubj = length(File);
        for i=1:nsubj   
        load(File(i).name);
